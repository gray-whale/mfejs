...
import { ERegistry, unpackTemplate, type MfeTemplate } from './template';
...
export default async ({
  ...
  const internalTemplatePrompts = async () => {
    intro(chalk.bgHex('#19BDD2')(' create-mfe '));
